    ...
    <section id="story" className="relative w-full bg-[var(--color-secondary)] py-24 overflow-hidden">
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div 
          ...
          transition={{ duration: 0.6 }}
        >
          <div className="bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-secondary)] rounded-2xl p-8 border-2 border-[var(--color-quaternary)]/20">
            <div className="text-center mb-8">
              <h3 className="text-2xl font-bold text-[var(--color-text-primary)] mb-4 flex items-center justify-center gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <motion.div
                className="bg-[var(--color-primary)] rounded-xl p-6 border-2 border-[var(--color-quaternary)]/20"
                whileHover={{ scale: 1.02 }}
                transition={{ duration: 0.2 }}
              >
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 bg-[var(--color-quaternary)] rounded-full flex items-center justify-center">
                    <FaMapMarkerAlt className="text-white" />
                  </div>
                  <h4 className="text-xl font-bold text-[var(--color-text-primary)]">Harderwijk</h4>
                </div>
                <p className="text-[var(--color-text-secondary)] mb-3">
                  {t('story.locations.harderwijk.description')}
                </p>
                <div className="flex items-center gap-2 text-sm text-[var(--color-quinary)]">
                  <FaRocket />
              ...
              <motion.div
                className="bg-[var(--color-primary)] rounded-xl p-6 border-2 border-[var(--color-quinary)]/20"
                whileHover={{ scale: 1.02 }}
                transition={{ duration: 0.2 }}
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h4 className="text-xl font-bold text-[var(--color-text-primary)]">Woerden</h4>
                </div>
                <p className="text-[var(--color-text-secondary)] mb-3">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div
              ...
              transition={{ duration: 0.2 }}
            >
              <div className="w-16 h-16 bg-[var(--color-quaternary)] rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <motion.div
              ...
              transition={{ duration: 0.2 }}
            >
              <div className="w-16 h-16 bg-[var(--color-quinary)] rounded-full flex items-center justify-center mx-auto mb-4">
            ...
            <motion.div
              ...
              transition={{ duration: 0.2 }}
            >
              <div className="w-16 h-16 bg-[var(--color-senary)] rounded-full flex items-center justify-center mx-auto mb-4">
