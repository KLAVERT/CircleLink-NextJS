...
const HeroSection = () => {
  ...
  return (
    <section className="relative w-full">
      ...
      <div 
        className="absolute inset-0 z-0 w-full h-full bg-[url('/images/webp/games/wallpapers/rust-background.webp')] bg-cover bg-center bg-no-repeat bg-[var(--color-primary)] bg-blend-overlay"
      >
      </div>
