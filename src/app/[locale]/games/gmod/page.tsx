...
const packagesDDR4: Package[] = [
  {
    ...
    price: "€10.00",
    ddr3Price: "€7.50",
    description: { key: "packages.gmod1.description" },
    features: [
        { text: { key: "packages.gmod1.features.ram" }, included: true },
        { text: { key: "packages.gmod1.features.cores" }, included: true },
        { text: { key: "packages.gmod1.features.storage" }, included: true },
        { text: { key: "packages.gmod1.features.pelican" }, included: true },
        { text: { key: "packages.gmod1.features.support" }, included: true },
        { text: { key: "packages.gmod1.features.databases" }, included: true },
        { text: { key: "packages.gmod1.features.backup" }, included: true },
    ],
    href: "#ddr4",
    ddr3Href: "#ddr3",
  },
  {
    ...
    price: "€17.50",
    ddr3Price: "€13.50",
    description: { key: "packages.gmod2.description" },
    features: [
        { text: { key: "packages.gmod2.features.ram" }, included: true },
        { text: { key: "packages.gmod2.features.storage" }, included: true },
        { text: { key: "packages.gmod2.features.storage" }, included: true },
        { text: { key: "packages.gmod2.features.pelican" }, included: true },
        { text: { key: "packages.gmod2.features.support" }, included: true },
        { text: { key: "packages.gmod2.features.databases" }, included: true },
        { text: { key: "packages.gmod2.features.backup" }, included: true },
    ],
    sub: true,
  ...
  },
  {
    ...
    price: "€22.50",
    ddr3Price: "€17.50",
    description: { key: "packages.gmod3.description" },
    features: [
        { text: { key: "packages.gmod3.features.ram" }, included: true },
        { text: { key: "packages.gmod3.features.cores" }, included: true },
        { text: { key: "packages.gmod3.features.storage" }, included: true },
        { text: { key: "packages.gmod3.features.pelican" }, included: true },
        { text: { key: "packages.gmod3.features.support" }, included: true },
        { text: { key: "packages.gmod3.features.databases" }, included: true },
        { text: { key: "packages.gmod3.features.backup" }, included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
  {
    ...
    price: "€30.00",
    ddr3Price: "€22.50",
    description: { key: "packages.gmod4.description" },
    features: [
        { text: { key: "packages.gmod4.features.ram" }, included: true },
        { text: { key: "packages.gmod4.features.cores" }, included: true },
        { text: { key: "packages.gmod4.features.storage" }, included: true },
        { text: { key: "packages.gmod4.features.pelican" }, included: true },
        { text: { key: "packages.gmod4.features.support" }, included: true },
        { text: { key: "packages.gmod4.features.databases" }, included: true },
        { text: { key: "packages.gmod4.features.backup" }, included: true },
    ],
    sub: true,
  ...
  },
  {
    ...
    price: "€37.50",
    ddr3Price: "€27.50",
    description: { key: "packages.gmod5.description" },
    features: [
        { text: { key: "packages.gmod5.features.ram" }, included: true },
        { text: { key: "packages.gmod5.features.cores" }, included: true },
        { text: { key: "packages.gmod5.features.storage" }, included: true },
        { text: { key: "packages.gmod5.features.pelican" }, included: true },
        { text: { key: "packages.gmod5.features.support" }, included: true },
        { text: { key: "packages.gmod5.features.databases" }, included: true },
        { text: { key: "packages.gmod5.features.backup" }, included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
  {
    ...
    price: "€45.00",
    ddr3Price: "€32.50",
    description: { key: "packages.gmod6.description" },
    features: [
        { text: { key: "packages.gmod6.features.ram" }, included: true },
        { text: { key: "packages.gmod6.features.cores" }, included: true },
        { text: { key: "packages.gmod6.features.storage" }, included: true },
        { text: { key: "packages.gmod6.features.pelican" }, included: true },
        { text: { key: "packages.gmod6.features.support" }, included: true },
        { text: { key: "packages.gmod6.features.databases" }, included: true },
        { text: { key: "packages.gmod6.features.backup" }, included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
    ...
    <main className="min-h-screen">
      ...
      <div className={`w-full transition-opacity duration-1000 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
        <GameHostingHero
          ...
          backgroundImage="/images/webp/games/wallpapers/gmod-background.webp"
          translationNamespace="gmod.hero"
        />
        <GamePackageSection
          title={{ key: 'packages.title' }}
          subtitle={{ key: 'packages.subtitle' }}
          packages={packagesDDR4}
          gameLogo="/images/webp/games/logos/gmod.webp"
          gameLogoAlt="Official gmod Logo from the game"
          enableBTWToggle={true}
          enableDDRToggle={true}
          translationNamespace="gmod"
        />
        <GameReviewSection
          title={{ key: 'title' }}
