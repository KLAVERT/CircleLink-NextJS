...
const HeroSection = () => {
  const t = useTranslations('fivem.hero');

  return (
    <section className="relative w-full">
      {/* Background with wallpaper and color tint */}
      <div 
        className="absolute inset-0 z-0 w-full h-full bg-[url('/images/webp/games/wallpapers/fivem-background.webp')] bg-cover bg-center bg-no-repeat bg-[var(--color-primary)] bg-blend-overlay"
      >
      </div>
