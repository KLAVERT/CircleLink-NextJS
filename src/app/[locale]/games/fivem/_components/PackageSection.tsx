...
const packagesDDR4: Package[] = [
  {
    ...
    features: [
        { text: "packages.starter.features.4gbddr4", included: true },
        { text: "packages.starter.features.2cores", included: true },
        { text: "packages.starter.features.fullssd", included: true },
        { text: "packages.starter.features.pelican", included: true },
        { text: "packages.starter.features.support", included: true },
        { text: "packages.starter.features.2databases", included: true },
        { text: "packages.starter.features.2backup", included: true },
    ],
    href: "#ddr4",
    ddr3Href: "#ddr3",
  },
  {
    ...
    features: [
        { text: "packages.basic.features.6gbddr4", included: true },
        { text: "packages.basic.features.2cores", included: true },
        { text: "packages.basic.features.fullssd", included: true },
        { text: "packages.basic.features.pelican", included: true },
        { text: "packages.basic.features.support", included: true },
        { text: "packages.basic.features.2databases", included: true },
        { text: "packages.basic.features.2backup", included: true },
    ],
    sub: true,
    subtext: "Recommended",
    href: "#",
  ...
  },
  {
    ...
    price: "€10.00",
    ddr3Price: "€7.50",
    description: "packages.normal.description",
    features: [
        { text: "packages.normal.features.8gbddr4", included: true },
        { text: "packages.normal.features.3cores", included: true },
        { text: "packages.normal.features.fullssd", included: true },
        { text: "packages.normal.features.pelican", included: true },
        { text: "packages.normal.features.support", included: true },
        { text: "packages.normal.features.2databases", included: true },
        { text: "packages.normal.features.2backup", included: true },
    ],
    sub: true,
    subtext: "Most Chosen",
    href: "#",
  ...
  },
  {
    ...
    price: "17.50",
    ddr3Price: "€12.50",
    description: "packages.medium.description",
    features: [
        { text: "packages.medium.features.12gbddr4", included: true },
        { text: "packages.medium.features.4cores", included: true },
        { text: "packages.medium.features.fullssd", included: true },
        { text: "packages.medium.features.pelican", included: true },
        { text: "packages.medium.features.support", included: true },
        { text: "packages.medium.features.2databases", included: true },
        { text: "packages.medium.features.2backup", included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
  {
    ...
    price: "€25.00",
    ddr3Price: "€17.50",
    description: "packages.large.description",
    features: [
        { text: "packages.large.features.16gbddr4", included: true },
        { text: "packages.large.features.4cores", included: true },
        { text: "packages.large.features.fullssd", included: true },
        { text: "packages.large.features.pelican", included: true },
        { text: "packages.large.features.support", included: true },
        { text: "packages.large.features.2databases", included: true },
        { text: "packages.large.features.2backup", included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
  {
    ...
    price: "€45.00",
    ddr3Price: "€32.50",
    description: "packages.ultra.description",
    features: [
        { text: "packages.ultra.features.20gbddr4", included: true },
        { text: "packages.ultra.features.6cores", included: true },
        { text: "packages.ultra.features.fullssd", included: true },
        { text: "packages.ultra.features.pelican", included: true },
        { text: "packages.ultra.features.support", included: true },
        { text: "packages.ultra.features.2databases", included: true },
        { text: "packages.ultra.features.2backup", included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {packages.slice(0, 6).map((pkg) => {
          ...
          return (
            <FeatureCard
              key={pkg.name}
              imagePath={"/images/webp/games/logos/fivem.webp"}
              imageAlt={"Official FiveM Logo from the game"}
              title={title}
