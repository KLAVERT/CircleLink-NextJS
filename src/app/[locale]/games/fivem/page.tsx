...
const packagesDDR4: Package[] = [
  {
    ...
    price: "€10.00",
    ddr3Price: "€7.50",
    description: { key: "packages.fivem1.description" },
    features: [
        { text: { key: "packages.fivem1.features.ram" }, included: true },
        { text: { key: "packages.fivem1.features.cores" }, included: true },
        { text: { key: "packages.fivem1.features.storage" }, included: true },
        { text: { key: "packages.fivem1.features.pelican" }, included: true },
        { text: { key: "packages.fivem1.features.support" }, included: true },
        { text: { key: "packages.fivem1.features.databases" }, included: true },
        { text: { key: "packages.fivem1.features.backup" }, included: true },
    ],
    href: "#ddr4",
    ddr3Href: "#ddr3",
  },
  {
    ...
    price: "€17.50",
    ddr3Price: "€13.50",
    description: { key: "packages.fivem2.description" },
    features: [
        { text: { key: "packages.fivem2.features.ram" }, included: true },
        { text: { key: "packages.fivem2.features.storage" }, included: true },
        { text: { key: "packages.fivem2.features.storage" }, included: true },
        { text: { key: "packages.fivem2.features.pelican" }, included: true },
        { text: { key: "packages.fivem2.features.support" }, included: true },
        { text: { key: "packages.fivem2.features.databases" }, included: true },
        { text: { key: "packages.fivem2.features.backup" }, included: true },
    ],
    sub: true,
  ...
  },
  {
    ...
    price: "€22.50",
    ddr3Price: "€17.50",
    description: { key: "packages.fivem3.description" },
    features: [
        { text: { key: "packages.fivem3.features.ram" }, included: true },
        { text: { key: "packages.fivem3.features.cores" }, included: true },
        { text: { key: "packages.fivem3.features.storage" }, included: true },
        { text: { key: "packages.fivem3.features.pelican" }, included: true },
        { text: { key: "packages.fivem3.features.support" }, included: true },
        { text: { key: "packages.fivem3.features.databases" }, included: true },
        { text: { key: "packages.fivem3.features.backup" }, included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
  {
    ...
    price: "€30.00",
    ddr3Price: "€22.50",
    description: { key: "packages.fivem4.description" },
    features: [
        { text: { key: "packages.fivem4.features.ram" }, included: true },
        { text: { key: "packages.fivem4.features.cores" }, included: true },
        { text: { key: "packages.fivem4.features.storage" }, included: true },
        { text: { key: "packages.fivem4.features.pelican" }, included: true },
        { text: { key: "packages.fivem4.features.support" }, included: true },
        { text: { key: "packages.fivem4.features.databases" }, included: true },
        { text: { key: "packages.fivem4.features.backup" }, included: true },
    ],
    sub: true,
  ...
  },
  {
    ...
    price: "€37.50",
    ddr3Price: "€27.50",
    description: { key: "packages.fivem5.description" },
    features: [
        { text: { key: "packages.fivem5.features.ram" }, included: true },
        { text: { key: "packages.fivem5.features.cores" }, included: true },
        { text: { key: "packages.fivem5.features.storage" }, included: true },
        { text: { key: "packages.fivem5.features.pelican" }, included: true },
        { text: { key: "packages.fivem5.features.support" }, included: true },
        { text: { key: "packages.fivem5.features.databases" }, included: true },
        { text: { key: "packages.fivem5.features.backup" }, included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
  {
    ...
    price: "€45.00",
    ddr3Price: "€32.50",
    description: { key: "packages.fivem6.description" },
    features: [
        ...
        { text: { key: "packages.fivem6.features.backup" }, included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
    ...
    <main className="min-h-screen">
      ...
      <div className={`w-full transition-opacity duration-1000 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
        <GameHostingHero
          ...
          backgroundImage="/images/webp/games/wallpapers/fivem-background.webp"
          translationNamespace="fivem.hero"
        />
        <GamePackageSection
          title={{ key: 'packages.title' }}
          subtitle={{ key: 'packages.subtitle' }}
          packages={packagesDDR4}
          gameLogo="/images/webp/games/logos/fivem.webp"
          gameLogoAlt="Official fivem Logo from the game"
          enableBTWToggle={true}
          enableDDRToggle={true}
          translationNamespace="fivem"
        />
        <GameReviewSection
          title={{ key: 'title' }}
