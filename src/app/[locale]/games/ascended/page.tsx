    ...
    <main className="min-h-screen">
      ...
      <div className={`w-full transition-opacity duration-1000 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
        <GameHostingHero
          ...
          backgroundImage="/images/webp/games/wallpapers/ascended-background.webp"
          translationNamespace="ascended.hero"
        />
        <GamePackageSection
          title={{ key: 'packages.title' }}
          subtitle={{ key: 'packages.subtitle' }}
          packages={packagesDDR4}
          gameLogo="/images/webp/games/logos/ascended.webp"
          gameLogoAlt="Official Ascended Logo from the game"
          enableBTWToggle={true}
          enableDDRToggle={false}
          translationNamespace="ascended"
        />
        <GameReviewSection
          title={{ key: 'title' }}
