...
const packagesDDR4: Package[] = [
  {
    ...
    features: [
        { text: { key: "packages.tatch.features.8gbddr4" }, included: true },
        { text: { key: "packages.tatch.features.3cores" }, included: true },
        { text: { key: "packages.tatch.features.fullssd" }, included: true },
        { text: { key: "packages.tatch.features.pelican" }, included: true },
        { text: { key: "packages.tatch.features.support" }, included: true },
        { text: { key: "packages.tatch.features.2databases" }, included: true },
        { text: { key: "packages.tatch.features.2backup" }, included: true },
    ],
    href: "#ddr4",
    ddr3Href: "#ddr3",
  },
  {
    ...
    features: [
        { text: { key: "packages.wood.features.10gbddr4" }, included: true },
        { text: { key: "packages.wood.features.4cores" }, included: true },
  ...
  },
  {
    ...
    features: [
        { text: { key: "packages.stone.features.12gbddr4" }, included: true },
  ...
  },
  {
    ...
    features: [
        { text: { key: "packages.metal.features.20gbddr4" }, included: true },
        { text: { key: "packages.metal.features.6cores" }, included: true },
  ...
  },
  {
    ...
    features: [
        { text: { key: "packages.tek.features.24gbddr4" }, included: true },
        { text: { key: "packages.tek.features.8cores" }, included: true },
        { text: { key: "packages.tek.features.fullssd" }, included: true },
        { text: { key: "packages.tek.features.pelican" }, included: true },
        { text: { key: "packages.tek.features.support" }, included: true },
        { text: { key: "packages.tek.features.2databases" }, included: true },
        { text: { key: "packages.tek.features.2backup" }, included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
    ...
    <main className="min-h-screen">
      ...
      <div className={`w-full transition-opacity duration-1000 ${isLoading ? 'opacity-0' : 'opacity-100'}`}>
        <GameHostingHero
          ...
          backgroundImage="/images/webp/games/wallpapers/ark-background.webp"
          translationNamespace="ark.hero"
        />
        <GamePackageSection
          title={{ key: 'packages.title' }}
          subtitle={{ key: 'packages.subtitle' }}
          packages={packagesDDR4}
          gameLogo="/images/webp/games/logos/ark.webp"
          gameLogoAlt="Official Ark Logo from the game"
          enableBTWToggle={true}
          enableDDRToggle={false}
          translationNamespace="ark"
        />
        <GameReviewSection
          title={{ key: 'title' }}
