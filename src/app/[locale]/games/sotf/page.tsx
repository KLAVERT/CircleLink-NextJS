...
const packagesDDR4: Package[] = [
  {
    ...
    price: "€10.00",
    ddr3Price: "€7.50",
    description: { key: "packages.sotf1.description" },
    features: [
        { text: { key: "packages.sotf1.features.ram" }, included: true },
        { text: { key: "packages.sotf1.features.cores" }, included: true },
        { text: { key: "packages.sotf1.features.storage" }, included: true },
        { text: { key: "packages.sotf1.features.pelican" }, included: true },
        { text: { key: "packages.sotf1.features.support" }, included: true },
        { text: { key: "packages.sotf1.features.databases" }, included: true },
        { text: { key: "packages.sotf1.features.backup" }, included: true },
    ],
    href: "#ddr4",
    ddr3Href: "#ddr3",
  },
  {
    ...
    price: "€17.50",
    ddr3Price: "€13.50",
    description: { key: "packages.sotf2.description" },
    features: [
        { text: { key: "packages.sotf2.features.ram" }, included: true },
        { text: { key: "packages.sotf2.features.storage" }, included: true },
        { text: { key: "packages.sotf2.features.storage" }, included: true },
        { text: { key: "packages.sotf2.features.pelican" }, included: true },
        { text: { key: "packages.sotf2.features.support" }, included: true },
        { text: { key: "packages.sotf2.features.databases" }, included: true },
        { text: { key: "packages.sotf2.features.backup" }, included: true },
    ],
    sub: true,
  ...
  },
  {
    ...
    price: "€22.50",
    ddr3Price: "€17.50",
    description: { key: "packages.sotf3.description" },
    features: [
        { text: { key: "packages.sotf3.features.ram" }, included: true },
        { text: { key: "packages.sotf3.features.cores" }, included: true },
        { text: { key: "packages.sotf3.features.storage" }, included: true },
        { text: { key: "packages.sotf3.features.pelican" }, included: true },
        { text: { key: "packages.sotf3.features.support" }, included: true },
        { text: { key: "packages.sotf3.features.databases" }, included: true },
        { text: { key: "packages.sotf3.features.backup" }, included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
  {
    ...
    price: "€30.00",
    ddr3Price: "€22.50",
    description: { key: "packages.sotf4.description" },
    features: [
        { text: { key: "packages.sotf4.features.ram" }, included: true },
        { text: { key: "packages.sotf4.features.cores" }, included: true },
        { text: { key: "packages.sotf4.features.storage" }, included: true },
        { text: { key: "packages.sotf4.features.pelican" }, included: true },
        { text: { key: "packages.sotf4.features.support" }, included: true },
        { text: { key: "packages.sotf4.features.databases" }, included: true },
        { text: { key: "packages.sotf4.features.backup" }, included: true },
    ],
    sub: true,
  ...
  },
  {
    ...
    price: "€37.50",
    ddr3Price: "€27.50",
    description: { key: "packages.sotf5.description" },
    features: [
        { text: { key: "packages.sotf5.features.ram" }, included: true },
        { text: { key: "packages.sotf5.features.cores" }, included: true },
        { text: { key: "packages.sotf5.features.storage" }, included: true },
        { text: { key: "packages.sotf5.features.pelican" }, included: true },
        { text: { key: "packages.sotf5.features.support" }, included: true },
        { text: { key: "packages.sotf5.features.databases" }, included: true },
        { text: { key: "packages.sotf5.features.backup" }, included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
  {
    ...
    price: "€45.00",
    ddr3Price: "€32.50",
    description: { key: "packages.sotf6.description" },
    features: [
        { text: { key: "packages.sotf6.features.ram" }, included: true },
        { text: { key: "packages.sotf6.features.cores" }, included: true },
        { text: { key: "packages.sotf6.features.storage" }, included: true },
        { text: { key: "packages.sotf6.features.pelican" }, included: true },
        { text: { key: "packages.sotf6.features.support" }, included: true },
        { text: { key: "packages.sotf6.features.databases" }, included: true },
        { text: { key: "packages.sotf6.features.backup" }, included: true },
    ],
    href: "#",
    ddr3Href: "#",
  },
...
export default function SOTFPage() {
